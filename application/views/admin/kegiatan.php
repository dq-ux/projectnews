                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-sm btn-danger" href="<?php echo base_url('admin/kegiatan/delete/'.$row->id_kegiatan) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
